        ...
        <Fragment>
            <div style={pageStyle}>
                ...
                <div style={{ width: x > 1304 ? "250px" : (x < 1304 && x > 695 ? "200px" : (x < 695 && x > 553 ? "120px" : "120px")), position: "relative", top: x > 1180 ?  "200px" : "170px", left: x > 1180 ?  "50px" : "10px", zIndex: 4 }}>
                    ...
                    <Typography id="range-slider" gutterBottom style={{ color: "#333", marginBottom: "5px", fontSize: '20px', fontWeight: "bold", marginTop: "15px", background: 'rgba(255, 255, 255, 0.7)', padding: '10px', borderRadius: '10px', boxShadow: '0 0 10px rgba(0, 0, 0, 0.9)' }}>
                        
                        <h5 style={{ fontSize: x > 695 ? '30px' : "17px", fontWeight: "bold" }}> {x > 1304 && (<i className="fa-solid fa-list"></i>)}Categories:</h5>
                        <ul>
